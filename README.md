...
The quickest way to get start with Node.Js & Express in TypeScript, just clone the project:

```bash
$ git clone https://github.com/arjunkhetia/Node.Js-Express-TypeScript-Project.git
```
